      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow">
          ...
          <label className="inline-block mb-4">
            ...
            {imageFile && (
              <span className="ml-2 text-sm">{imageFile.name}</span>
            )}
          </label>
          <textarea
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          {books.map((book) => (
            <div
              key={book._id}
              className="w-full border p-4 rounded bg-gray-50 shadow-sm flex flex-col justify-between h-full"
            >
              <div>
